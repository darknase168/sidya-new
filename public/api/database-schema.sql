-- SIDYA Organization Chart Database Schema
...
-- Create employees/pengurus table
...
CREATE TABLE IF NOT EXISTS pengurus_audit (
  ...
  INDEX idx_pengurus_id (pengurus_id),
...
INSERT INTO pengurus (id, code, placeholderName, roleLabel, realisticName, officialTitle, department, level, colorTheme, avatarUrl, avatarKey, email, phone, location, responsibilities, childrenIds) VALUES
('kom-iii', 'KOM-04', 'NAME LASTNAME', 'KOMISARIS III', 'Ir. Sutrisno Budiharto, M.B.A.', 'Komisaris (Perwakilan Pemegang Saham)', 'Dewan Komisaris', 0, 'gold', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80', 'kom-iii', 'sutrisno@sidya.co.id', '+62 813-4567-8901', 'Kantor Pusat - Jakarta', '["Mewakili kepentingan pemegang saham utama","Melakukan monitoring finansial dan investasi","Memberikan arahan dalam pengembangan strategi jangka panjang","Memastikan pertumbuhan nilai perusahaan"]', '[]');

INSERT INTO pengurus (id, code, placeholderName, roleLabel, realisticName, officialTitle, department, level, colorTheme, avatarUrl, avatarKey, email, phone, location, responsibilities, parentId, childrenIds) VALUES
